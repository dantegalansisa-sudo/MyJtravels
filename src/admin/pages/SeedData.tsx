...
const testimonials = [
  { name: 'Carmen Rodríguez', initials: 'CR', location: 'Villa Mella, SDN', destination: 'Voló a Miami', text: 'M&J me consiguió el vuelo más barato que encontré. El proceso fue súper fácil por WhatsApp y me ayudaron con todo. ¡Ya reservé mi segundo viaje con ellos!', rating: 5, order: 0, active: true },
...
const faqs = [
  { question: '¿Cómo puedo reservar un vuelo?', answer: 'Usa nuestro buscador de vuelos en la portada o escríbenos directamente por WhatsApp al 829-874-0109. Te enviamos la cotización en menos de 5 minutos y puedes reservar con solo RD$2,000.', order: 0, active: true },
...
const teamMembers = [
  { name: 'Jesús de la Cruz Disla', role: 'Presidente', bio: 'Empresario y líder estratégico de M&J Travels. Dirige con visión el crecimiento de la agencia y la expansión de destinos.', imageUrl: '', instagram: '@myjtravelsrd', isLeadership: true, leadershipGroupImage: '/imagenes/presidente-vicepresidenta.jpeg', order: 0, active: true },
  { name: 'Maridania Gerbacio', role: 'Vicepresidenta', bio: 'Mercadóloga y líder organizacional de M&J Travels. Se destaca por su liderazgo en la optimización de procesos.', imageUrl: '', instagram: '@myjtravelsrd', isLeadership: true, leadershipGroupImage: '/imagenes/presidente-vicepresidenta.jpeg', order: 1, active: true },
  { name: 'Yudelka Mejía', role: 'Encargada de Operaciones', bio: 'Pilar fundamental en el día a día de la agencia, se encarga de la atención personalizada a cada cliente.', imageUrl: '/imagenes/encargada.jpeg', instagram: '@myjtravelsrd', isLeadership: false, leadershipGroupImage: null, order: 2, active: true },
];
...
const heroConfig = {
  ...
  badgeText: 'Agencia Registrada · CESDN', videoUrl: '',
  trustItems: ['Respuesta en menos de 5 min', 'Precio garantizado', 'Pago en pesos o dólares'],
};

const contactConfig = {
  whatsappPrimary: '18298740109', whatsappSecondary: '18296697762',
  email: 'mjtravel.srl@hotmail.com',
  address: 'Av. Charles de Gaulle esq. Hermanas Mirabal, Plaza Concordia, Villa Mella, SDN',
