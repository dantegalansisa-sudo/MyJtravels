  ...
  members: [
    {
      ...
      role: 'Presidente',
      bio: 'Empresario y líder estratégico de M&J Travels. Dirige con visión el crecimiento de la agencia y la expansión de destinos. Su enfoque está en posicionar a M&J como referente nacional e internacional, ofreciendo viajes confiables y de calidad. Trabaja para conectar a más clientes con nuevas oportunidades alrededor del mundo.',
    },
    {
      name: 'Maridania Gerbacio',
      role: 'Vicepresidenta',
      bio: 'Mercadóloga y líder organizacional de M&J Travels. Se destaca por su liderazgo en la optimización de procesos e impulsa iniciativas que fortalecen la experiencia del viajero. Su gestión promueve una agencia eficiente y en constante crecimiento.',
    },
  ],
          ...
          <motion.div className="team-card team-card--leadership" variants={fadeInUp}>
            <div className="team-card__image-wrap">
              <img
                ...
                alt="Presidente y Vicepresidenta de M&J Travels"
