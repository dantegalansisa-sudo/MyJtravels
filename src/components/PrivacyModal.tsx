      ...
      <div className="privacy-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="privacy-modal__content">
          <section>
            ...
            <p>
              M&J Travels SRL recopila información personal que usted nos proporciona voluntariamente al contactarnos
          ...
          <section>
            ...
            <ul>
              <li>WhatsApp: 829-874-0109 / 829-669-7762</li>
              <li>Email: mjtravel.srl@hotmail.com</li>
              <li>Dirección: Plaza Concordia, Villa Mella, Santo Domingo Norte</li>
            </ul>
          </section>
